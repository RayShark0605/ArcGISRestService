#ifndef GEOBASE_TIMER_H_H
#define GEOBASE_TIMER_H_H
 ...
 */
ARCGIS_RESTSERVICE_PORT std::string GetLocalTimeStr(bool withMs = true, bool withTzSuffix = false);
 ...
 */
class ARCGIS_RESTSERVICE_PORT GB_Timer
{
public:
    // 等价于调用 Reset()，不在计时中
    GB_Timer();
 ...
 */
class ARCGIS_RESTSERVICE_PORT GB_ScopeTimer
{
public:
    /**
     * @brief 上报回调函数类型。
